...
const Login = () => {
    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            ...
            {/* login part */}
            <div className="flex flex-col w-full gap-2 justify-center items-center px-2 md:p-10">

                {/* <button
                    className="flex items-center sm:w-64 w-full bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
...
//     description: "Login the website is a crowdfunding platform for creaters",
// };
